/* ============================================================
   ...
   ============================================================ */
const PUBS = [
{y:2026, t:"An Empirical Study of Ethical HUMINT through Human-in-the-Loop LLM Dialogue Support", a:"Sota Kubo, Yukihiro Nagayama, Yin Minn Pa Pa, Katsunari Yoshioka", v:"Security Summer Summit (SSS) Conference, Japan", tags:[], links:[["Paper","https://ymppjp.github.io/files/kubokun_SSS_2026.pdf"]]},
{y:2026, t:"LLM-Based Information Gathering and Analysis System for Cybercrime-Related Messages on Discord", a:"Naoki Miyamoto, Yamato Kawaguchi, Yin Minn Pa Pa, Katsunari Yoshioka", v:"Security Summer Summit (SSS) Conference, Japan", tags:[], links:[["Paper","https://ymppjp.github.io/files/miyamotokun_SSS_2026.pdf"]]},
{y:2026, t:"Measuring Third-Party Service Dependencies in Darknet Markets", a:"Akinori Uchino, Aiman Syazwan Bin Abdul Razak, Yin Minn Pa Pa, Katsunari Yoshioka", v:"Security Summer Summit (SSS) Conference, Japan", tags:[], links:[["Paper","https://ymppjp.github.io/files/uchinokun_SSS_2026.pdf"]]},
{y:2026, t:"Analysis of Double-Extortion Negotiation Strategies and Shared Victims Across Ransomware Groups Based on Ransomware Leak Site Observations", a:"Tatsuki Yogo, Yin Minn Pa Pa, Junji Shikata, Katsunari Yoshioka", v:"Security Summer Summit (SSS) Conference, Japan", tags:[], links:[["Paper","https://ymppjp.github.io/files/yogokun_SSS_2026.pdf"]]},
...
{y:2026, t:"Leveraging LLMs to Generate and Counter Sandbox Evasion Techniques", a:"Anh Nguyen Van, Matsuzawa Hikaru, Ito Hikaru, Yin Minn Pa Pa, Rui Tanabe, Katsunari Yoshioka", v:"NDSS 2026, USA", tags:["Poster"], links:[["Poster","https://ymppjp.github.io/files/ndss26_poster_53.pdf"]]},
...
const TALKS = [
{y:2026, t:"ランサムウェアグループはどのように被害者を追い詰めるのか？ ~ LockBit 3.0リークサイトの長期観測から見えた恐喝戦略と摘発の影響 ~", v:"Invited Talk — FIT 2026 conference, Japan"},
{y:2025, t:"AI Meets Cybercrime: From Simulation to Structured Intelligence of Cybercrime Ecosystems", v:"Invited Talk — Asia JCIS 2025, Seoul, Korea"},
{y:2024, t:"The Abuse of AI in Cybersecurity", v:"7th Workshop on Intelligent IoT for Empowering People's Lifestyle and Well-being, Kyoto, Japan"},
{y:2024, t:"Cyber Security Women's Success and Career Paths", v:"Panel Discussion — Nihonbashi Tower, Tokyo, Japan"},
{y:2023, t:"AI and Security", v:"Panel Discussion — 8th Franco-Japanese Cybersecurity Workshop, Bordeaux, France"},
{y:2023, t:"The Dark Side of AI in Cybersecurity", v:"Invited Talk — 8th Franco-Japanese Cybersecurity Workshop, Bordeaux, France"},
{y:2023, t:"攻撃者の夢？ChatGPTのマルウェア開発能力を探る", v:"Requested Talk — Communication Systems Conference, Shizuoka, Japan"},
{y:2023, t:"攻撃者の夢？ChatGPTのマルウェア開発能力を探る", v:"Invited Talk — IoT Security Forum 2023, Japan"},
{y:2020, t:"Education in 20xx & Society 5.0 in Japan, The Art of 21st Century Learning", v:"Myanmar Gateway Engineering and Consultancy, Online"},
{y:2020, t:"New Trends in Technologies", v:"Myanmar Science and Technological Community, Online"},
{y:2020, t:"Ask Me Anything About Cybersecurity", v:"Panel Q&A (with Noam Rabinovich, Sean Neary) — Money20/20 Asia, Singapore"},
{y:2019, t:"Mind the Hack", v:"Panel Discussion (with Kevyn Yong, Eric Hoh) — Money20/20 Asia, Singapore"},
{y:2018, t:"Cyber Security Jobs in Japan", v:"Things Talk@UIT — University of Information Technology, Myanmar"},
{y:2017, t:"Tracing the Hacker", v:"Yangon Technological University, Myanmar"},
{y:2017, t:"Cyber Security Awareness Seminar", v:"Yangon City Development Committee, Myanmar"},
{y:2017, t:"デコイになって落とせ！: Exploit Kitをテイクダウンする新たな手法", v:"With Kamizono, Kumagai, Kasama — AV Tokyo 2017, Japan"},
{y:2017, t:"サイバー攻撃観測記録 〜彼の名はヨセフ〜", v:"With Kumagai, Kamizono, Tsuda — AV Tokyo 2017, Japan"},
{y:2016, t:"IoTPOT Updates", v:"Delft University of Technology, Netherlands"},
{y:2015, t:"IoTPOT", v:"University of California, Santa Barbara and Northeastern University, Boston, USA"},
];
